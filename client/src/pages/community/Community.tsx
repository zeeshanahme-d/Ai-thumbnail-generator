...
const Community = () => {
    return (
        <div className="relative flex flex-col items-center px-4 md:px-10 lg:px-24 xl:px-32 mt-44">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 items-start mt-10">
                {ThumbnailData?.map((thumbnail, index) => {
                    return (
                        <div key={index} className="group relative rounded-2xl bg-white/6 border border-white/10 transition shadow-xl overflow-hidden ">
